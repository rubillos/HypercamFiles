...
sounds_folder = "/home/pi/Duet-printmonitor/sounds"
...
create_movie = True
encoding_options = "-b:v 10M -minrate 3M -maxrate 15M -bufsize 15M -c:v h264_omx -vf format=yuv420p -profile:v high"
